<?php
	...
	function alobaidi_time_ago_settings() {
		add_plugins_page( 'Time Ago Settings', 'Time Ago', 'manage_options', 'alobaidi_time_ago_settings', 'alobaidi_time_ago_settings_page' );
	}
	add_action( 'admin_menu', 'alobaidi_time_ago_settings' );

	function alobaidi_time_ago_register_settings() {
		register_setting( 'alobaidi_time_ago_setting', 'wptta_min' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_mins' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_hour' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_hours' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_day' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_days' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_week' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_weeks' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_month' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_months' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_year' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_years' );
		register_setting( 'alobaidi_time_ago_setting', 'wptta_comments' );
	}
	add_action( 'admin_init', 'alobaidi_time_ago_register_settings' );
		
	function alobaidi_time_ago_settings_page(){ // settings page function
		...
		?>
			<div class="wrap">
            	...
            	<form method="post" action="options.php">
                	<?php settings_fields( 'alobaidi_time_ago_setting' ); ?>
